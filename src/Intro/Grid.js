        ...
        return (
            <div className={classes.container}>
                <div className={classes.main}>
                    ...
                    <ScrollAnimation animateOut='fadeOutDown' duration={2} animateIn='fadeInDown' className={`${classes.skills} ${classes.box}`}><div className={classes.box}><ColorBox color={'#004346'} icon={'fas fa-code'} title={'Skills'}/></div></ScrollAnimation >
