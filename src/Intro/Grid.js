        ...
        return (
            <div className={classes.container}>
                <div className={classes.main}>
                   ...
                   <ScrollAnimation delay={0} animateOut='fadeOutDown' duration={2} animateIn='fadeInDown' className={`${classes.blog} ${classes.box}`}><button onClick={() => {this.props.blog()}} className={classes.box}><ColorBox color={'#74B3CE'} icon={'fas fa-code'} title={'Blog'}/></button></ScrollAnimation >
