...
import port10 from '../media/port10.JPG'
        ...
        <div className={classes.container}>
            <div className={classes.main}>
                ...
                <div className={classes.mid}>
                    ...
                    <ScrollAnimation  animateOnce={true} duration={2} animateIn='fadeIn' className={classes.project}>
                    <Project img={port10} title={'HTML5 banner'} demo={'https://github.com/brandonjoe/VMXbanners'} languages={'HTML, CSS, Javascript'} github={'https://github.com/brandonjoe/VMXbanners'} text={'Banners Ads for VMX Vet Convention'} className={classes.project}/>
                    </ScrollAnimation>
                    <ScrollAnimation  animateOnce={true} duration={2} animateIn='fadeIn'className={classes.project}>
                    <Project img={port5} title={'Sovalineups.com'} demo={'https://sovalineups.com/'} languages={'HTML/CSS, React'} github={'https://github.com/brandonjoe/store'} text={'App for Valorant to help player lineups'} className={classes.project}/>
                    </ScrollAnimation>
                    <ScrollAnimation  animateOnce={true} duration={2} animateIn='fadeIn'className={classes.project}>
                    <Project img={port7} title={'Steamnews.info'} demo={'http://steamnews.info/'} languages={'React, Node/Express'} github={'https://github.com/brandonjoe/SteamApp'} text={'Generates current news for Steam games you play.'} className={classes.project}/>
                    </ScrollAnimation>
                    <ScrollAnimation  animateOnce={true} duration={2} animateIn='fadeIn'className={classes.project}>
                    ...
                    <ScrollAnimation  animateOnce={true} duration={2} animateIn='fadeIn'className={classes.project}>
                    <Project img={port4} title={'CodeGig'} demo={'https://codegigs.herokuapp.com/'} languages={'Node/Exp, PostgreSQL '} github={'https://github.com/brandonjoe/codegig'} text={'App made for both developers and employers for small gigs.'} className={classes.project}/>
                    </ScrollAnimation>
                    <ScrollAnimation  animateOnce={true} duration={2} animateIn='fadeIn'className={classes.project}>
